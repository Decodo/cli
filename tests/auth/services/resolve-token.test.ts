...
describe('resolveAuthToken', () => {
  ...
  it('prefers flag over env and config', async () => {
    ...
    const { resolveAuthToken } = await import('../../../src/auth/services/resolve-token.js');
...
describe('requireAuthToken', () => {
  ...
  it('throws AuthRequiredError when no token is available', async () => {
    const { requireAuthToken } =
      await import('../../../src/auth/services/resolve-token.js');
    const { AuthRequiredError } =
      await import('../../../src/auth/errors/auth-required-error.js');
